...
namespace SV22T1020433.BusinessLayers
{
    ...
    public static class HRDataService
    {
        ...
        public static async Task<bool> SetEmployeePasswordAsync(int employeeID, string passwordHash)
        {
            return await employeeDB.SetPasswordAsync(employeeID, passwordHash);
        }
